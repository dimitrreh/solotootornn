...
scan = requests.get('https://pastebin.com/raw/DE837rdZ').text
...
try:
    ...
    if ip in scan:
        ...
        print('Welcome to Borderline & Scoobys Solo autoclaimer')

    else:

        print(f"{ip} Your IP is not authenticated! Please message one of the admins if you bought, but do not have access!")
